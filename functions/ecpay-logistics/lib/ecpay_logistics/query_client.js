        ...
        if (params.constructor === Object) {
            ...
            if (this.helper.is_contractor()) {
                ...
                if (params['MerchantID'] === null) {
                    functions.logger.error(`[MerchantID] should be specified when you're contractor-Platform.`)
            ...
            functions.logger.error(`Received parameter object must be a Object.`)
        ...
        if (apiname === 'Map' || apiname === 'printTradeDocument') {
            ...
            return new Promise((resolve, reject) => {
                resp.then(function (result) {
                    ...
                    functions.logger.error(333, err)
                    reject(err);
                });
            });
        }
